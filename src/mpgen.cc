...
int main(int argc, char **argv)
{
	...
	// Look at the options
	int optionChar = getopt_long(argc, argv, "cd:f:hm:o:v", g_longOptions, &longOptionIndex);
	while (optionChar != -1)
	{
		switch (optionChar)
		{
		...
		// Next option
		optionChar = getopt_long(argc, argv, "cd:f:hm:o:v", g_longOptions, &longOptionIndex);
	}
